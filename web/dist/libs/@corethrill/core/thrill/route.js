...
import m from './hyperscript/hyperscript.js'
import censor from './censor.js'
import { build as buildPathname, parse as parsePathname, compileTemplate } from './pathname.js'


var sentinel = {}

export default function(mountSpace) {
